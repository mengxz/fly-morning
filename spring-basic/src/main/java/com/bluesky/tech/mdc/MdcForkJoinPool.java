...
public final class MdcForkJoinPool extends ForkJoinPool {
     ...
     *                    <p>{@link #defaultForkJoinWorkerThreadFactory}.
     * @param handler     the handler for internal worker threads that terminate due to unrecoverable errors encountered
     *                    <p>while executing tasks. For default value, use {@code null}.
     * @param asyncMode   if true, establishes local first-in-first-out scheduling mode for forked tasks that are never
     *                    <p>joined. This mode may be more appropriate than default locally stack-based mode in applications
     *                    <p>in which worker threads only process event-style asynchronous tasks. For default value, use
     *                    <p>{@code false}.
     ...
     *                                  <p>because it does not hold
     *                                  <p>{@link RuntimePermission}{@code ("modifyThread")}
     */
